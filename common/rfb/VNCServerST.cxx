...
// parseRegionPart and mixedPercentages helper functions removed - now in DLPSettings.cxx
    ...
    clipboardId(0), sendWatermark(false)
{
  ...
  // DLP_Region initialization removed - now per-user in VNCSConnectionST::dlpSettings
...
// translateDLPRegion and blackOut methods removed - now per-user in VNCSConnectionST::dlpSettings
...
void VNCServerST::writeUpdate()
{
  ...
  // DLP Region filtering is now done per-user in VNCSConnectionST::applyDLPRegion()
